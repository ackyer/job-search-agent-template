...
casi todos buscan; `/CLAUDE.md` y `/GEMINI.md`, en la raíz del repositorio, solo apuntan ahí.
Si el tuyo no lee ninguno de los tres, dile al empezar: «lee `AGENTS.md` y sigue esas
instrucciones».
...
| `/CLAUDE.md` · `/GEMINI.md` | En la raíz del repositorio: punteros de una línea que llevan a `AGENTS.md`, para las herramientas que buscan su propio nombre de archivo. | No |
...
```bash
git rm --cached es/PERFIL_CANDIDATO.md && echo "PERFIL_CANDIDATO.md" >> .gitignore
```
